...
class ContactListPolicy
{
    ...
    {
        return $user->hasRole('super-admin') || $user->hasPermissionTo('view lists');
    }
    ...
    {
        return $user->hasRole('super-admin') || $user->hasPermissionTo('create lists');
    }
    ...
    {
        return $user->hasRole('super-admin') || $user->hasPermissionTo('edit lists');
    }
    ...
    {
        return $user->hasRole('super-admin') || $user->hasPermissionTo('delete lists');
    }
